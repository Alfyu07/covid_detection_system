...
const Color secondaryColor = Color(0xffD6A93B);
const Color blackColor = Color(0xff111322);
const Color ghostWhiteColor = Color(0xffF1F2F8);
...
TextStyle lightFont =
    const TextStyle(fontWeight: FontWeight.w300, color: blackColor);

TextStyle whiteMediumFont =
    const TextStyle(fontWeight: FontWeight.w500, color: whiteColor);
TextStyle whiteLightFont =
    const TextStyle(fontWeight: FontWeight.w300, color: whiteColor);
